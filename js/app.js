(() => {
    ...
    function initSliders() {
        if (document.querySelector(".second-block-swiper")) new core(".second-block-swiper", {
            ...
            grabCursor: true,
            navigation: {
                prevEl: ".second-block-swiper .second-block-swiper__arrows_prev",
                nextEl: ".second-block-swiper .second-block-swiper__arrows_next"
            },
            keyboard: {
                enabled: true,
                onlyInViewport: true,
